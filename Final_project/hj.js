...
// tables for the patients     
    ...
    response_form += `<tr><td> ${res_json[i].Bdate}</td>`;
    response_form += `<tr><td> ${res_json[i].Fname}</td>`;
    response_form += `<tr><td> ${res_json[i].Minit}</td>`;
    response_form += `<tr><td> ${res_json[i].Lname}</td>`;
    response_form += `<tr><td> ${res_json[i].Address}</td>`;
    response_form += `<tr><td> ${res_json[i].Gender}</td>`;
    response_form += `<tr><td> ${res_json[i].Inumber}</td>`;
    response_form += `<tr><td> ${res_json[i].Phone}</td>`;
    response_form += `<tr><td> ${res_json[i].Email}</td>`;